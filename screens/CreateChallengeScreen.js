...
function addNewChallenge(challengeId, name, type, description, image, badge, goal1, goal2, goal3, tags) {
    ...
    return (
        <View style={StyleSheet.container}>
            ...
            <Text style={styles.instructions}>
              Fill out the information below to create a challenge the Fitopolis Community can participate in!
            </Text>
